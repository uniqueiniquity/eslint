 ...
 */
function resolveParserOptions(parserName, providedOptions, enabledEnvironments, cwd) {
    const parserOptionsFromEnv = enabledEnvironments
        .filter(env => env.parserOptions)
        .reduce((parserOptions, env) => ConfigOps.merge(parserOptions, typeof env.parserOptions === "function" ? env.parserOptions({ cwd }) : env.parserOptions), {});
...
module.exports = class Linter {
    ...
    _verifyWithoutProcessors(textOrSourceCode, providedConfig, filenameOrOptions) {
        ...
        const parserOptions = resolveParserOptions(parserName, config.parserOptions || {}, enabledEnvs, config.options && config.options.cwd || process.cwd());
